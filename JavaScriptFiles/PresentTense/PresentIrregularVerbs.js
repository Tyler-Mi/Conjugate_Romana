import { PresentANoInflux, PresentTenseIrregular } from '../Global/listOfAllVerbs.js';
import { updateRealAnswer, handleSubmit, runReset, startTimer } from '../Global/globalFunctions.js';
...
let selectedVerb;
let selectedPronoun;
let verbList = PresentTenseIrregular;
