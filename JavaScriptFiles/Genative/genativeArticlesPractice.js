import { verifyFirstEntry, verifySecondEntry, verifyThridEntry, verifyFourthEntry, verifyFithEntry, verifySixthEntry, verifySeventhEntry, verifyEighthEntry } from '../Global/globalFunctions.js';
...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    document.getElementById("enter").onclick = function () {
        ...
        console.log(`User Entry: ${thirdUserEntry}`);

        // Verifying entries
        ({ numeratorPointTotal, denominatorPointTotal, percentPointTotal, firstUserEntry } = verifyFirstEntry(numeratorPointTotal, denominatorPointTotal, percentPointTotal, checkMark, xMark, firstUserEntry, AnswerOne));
        ...
        ({ numeratorPointTotal, denominatorPointTotal, percentPointTotal, secondUserEntry } = verifySecondEntry(numeratorPointTotal, denominatorPointTotal, percentPointTotal, checkMark, xMark, secondUserEntry, AnswerTwo));
        ...
        ({ numeratorPointTotal, denominatorPointTotal, percentPointTotal, thirdUserEntry } = verifyThridEntry(numeratorPointTotal, denominatorPointTotal, percentPointTotal, checkMark, xMark, thirdUserEntry, AnswerThree));
        ...
        ({ numeratorPointTotal, denominatorPointTotal, percentPointTotal, fourthUserEntry } = verifyFourthEntry(numeratorPointTotal, denominatorPointTotal, percentPointTotal, checkMark, xMark, fourthUserEntry, AnswerFour));
        ...
        ({ numeratorPointTotal, denominatorPointTotal, percentPointTotal, fithUserEntry } = verifyFithEntry(numeratorPointTotal, denominatorPointTotal, percentPointTotal, checkMark, xMark, fithUserEntry, AnswerFive));
        ...
        ({ numeratorPointTotal, denominatorPointTotal, percentPointTotal, sixthUserEntry, } = verifySixthEntry(numeratorPointTotal, denominatorPointTotal, percentPointTotal, checkMark, xMark, sixthUserEntry, AnswerSix));
        ...
        ({ numeratorPointTotal, denominatorPointTotal, percentPointTotal, seventhUserEntry } = verifySeventhEntry(numeratorPointTotal, denominatorPointTotal, percentPointTotal, checkMark, xMark, seventhUserEntry, AnswerSeven));
        ...
        ({ numeratorPointTotal, denominatorPointTotal, percentPointTotal, eighthUserEntry } = verifyEighthEntry(numeratorPointTotal, denominatorPointTotal, percentPointTotal, checkMark, xMark, eighthUserEntry, AnswerEight));
